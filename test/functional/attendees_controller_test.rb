...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post :create, attendee: { email: @attendee.email, first_name: @attendee.first_name, last_name: @attendee.last_name, phone: @attendee.phone }
    end
  ...
  test "should update attendee" do
    put :update, id: @attendee, attendee: { email: @attendee.email, first_name: @attendee.first_name, last_name: @attendee.last_name, phone: @attendee.phone }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
