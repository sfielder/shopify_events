...
class TicketTypesControllerTest < ActionController::TestCase
  ...
  test "should create ticket_type" do
    assert_difference('TicketType.count') do
      post :create, ticket_type: { description: @ticket_type.description, name: @ticket_type.name, price: @ticket_type.price, quantity: @ticket_type.quantity }
    end
  ...
  test "should update ticket_type" do
    put :update, id: @ticket_type, ticket_type: { description: @ticket_type.description, name: @ticket_type.name, price: @ticket_type.price, quantity: @ticket_type.quantity }
    assert_redirected_to ticket_type_path(assigns(:ticket_type))
  end
